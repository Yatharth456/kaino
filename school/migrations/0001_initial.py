    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Admin'), (2, 'Student'), (3, 'Teacher'), (4, 'Parent')], null=True)),
                ...
                ('profile_img', models.ImageField(blank=True, default=None, upload_to='profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principal_name', models.CharField(blank=True, max_length=124, null=True)),
                ...
                ('cover', models.ImageField(blank=True, null=True, upload_to='school_profile/')),
                ('slogan', models.CharField(blank=True, max_length=255, null=True)),
                ('logo_img', models.ImageField(blank=True, null=True, upload_to='school_logo/')),
            ],
        ),
        migrations.CreateModel(
            name='Session',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.lession')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='school.session')),
